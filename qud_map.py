...
def main():
    ...
    zoom_level, camera_offset = 3.0, [0, 0]
    is_panning, pan_start_pos = False, (0, 0)
    show_controls_hud, follow_mode, show_names = True, True, True
    name_font_cache = {}
